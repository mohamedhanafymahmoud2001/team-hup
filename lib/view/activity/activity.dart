                        ...
                        children: [
                          Expanded(
                            child: InputSearch(
                                ...
                                icon: IconButton(
                                    onPressed: () {},
                                    icon: Icon(Icons.search,color: colorsApp.colorgreyapp,)),
                          ...
                          Container(
                            ...
                            child: IconButton(
                                ...
                                icon: Icon(Icons.filter_alt_outlined,color: colorsApp.colorgreyapp,)),
                          )
                        ],
                      ),
                    ),
                            ...
                            children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: colorsApp.colorgreyapp.withOpacity(
                                          0.3), // لون الظل مع شفافية
